# ############################################################################
#
# build_f9pcap_si_xc7k480t_7s32x4_dram_10sfp.tcl
#
# 使用 dram buffer
# 使用 sfp * 10 版本
#
...
#
# ############################################################################
set  ::proj_name   f9pcap_si_xc7k480t_7s32_dram_10sfp
...
add_files ../rtl/f9pcap_si_xc7k480t_dram_10sfp.sv
set_property top f9pcap_si_xc7k480t_dram_10sfp [current_fileset]
...
add_files -fileset constrs_1              ../rtl/f9pcap_si_xc7k480t_10sfp.xdc
